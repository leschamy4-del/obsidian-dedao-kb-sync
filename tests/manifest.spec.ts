...
describe('plugin manifest', () => {
  ...
  it('keeps legacy and current brand terms searchable in the description', () => {
    expect(manifest.description).toContain('Dedao Brain');
    expect(manifest.description).toContain('knowledge bases');
    expect(manifest.description).toContain('blogger');
